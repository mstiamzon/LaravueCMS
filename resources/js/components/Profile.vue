    ...
    <div class="container">
        ...
        <div class="col-md-12">
              ...
              <div class="widget-user-header text-white" style="background: url('../dist/img/photo1.png') center center;">
                <h3 class="widget-user-username text-right black">{{this.form.name}}</h3>
                <h5 class="widget-user-desc text-right black">{{this.form.type}}</h5>
              </div>
                  ...
                  <div class="active tab-pane" id="activity">
                    ...
                    <div class="post">
                      <div class="user-block">
                        <img class="img-circle img-bordered-sm" src="/img/man2.png" alt="user image">
                        <span class="username">
                    ...
                    <div class="post clearfix">
                      <div class="user-block">
                        <img class="img-circle img-bordered-sm" src="/img/man3.png" alt="User Image">
                        <span class="username">
                          <a href="#">Sarah Ross</a>
                          <a href="#" class="float-right btn-tool"><i class="fas fa-times"></i></a>
                        </span>
                    ...
                    <div class="post">
                      <div class="user-block">
                        <img class="img-circle img-bordered-sm" src="/img/girl2.png" alt="User Image">
                        <span class="username">
                          <a href="#">Adam Jones</a>
                          <a href="#" class="float-right btn-tool"><i class="fas fa-times"></i></a>
                        </span>
                      ...
                      <div class="row mb-3">
                        <div class="col-sm-6">
                          <img class="img-fluid" src="/img/man.png" alt="Photo">
                        </div>
                        <!-- /.col -->
                        <div class="col-sm-6">
                          <div class="row">
                            <div class="col-sm-6">
                              <img class="img-fluid mb-3" src="/img/girl2.png" alt="Photo">
                              <img class="img-fluid" src="/img/girl.png" alt="Photo">
                            </div>
                            <!-- /.col -->
                            <div class="col-sm-6">
                              <img class="img-fluid mb-3" src="/img/girl.png" alt="Photo">
                              <img class="img-fluid" src="/img/girl.png" alt="Photo">
                            </div>
                            <!-- /.col -->
                          </div>
